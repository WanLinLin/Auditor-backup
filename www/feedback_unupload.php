...
$sql0 = "SELECT * FROM `user` where `value` = '0'";
?>
...
<body>
	<div class="container">
		...
		<ul class="nav nav-tabs">
			<li role="presentation" class="active"><a href="#">未上傳</a></li>
			<li role="presentation"><a href="./feedback_upload.php">已上傳</a></li>
			<form method="post" action="feedback_act_new.php" >
					...
					<?php
						foreach( $db->query( $sql0 ) as $row )
						{
							...
							<tr>
								...
								<td align="center">
									<input type="checkbox" name="cId[]" value="'.$row[0].'" />
								</td>
							</tr>';
