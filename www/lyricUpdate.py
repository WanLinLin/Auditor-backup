...
tempLyric = lyric.decode('big5').encode('utf8')
print type(tempLyric)
print len(tempLyric)
print repr(tempLyric)
print tempLyric
...
userContext = lyric.decode('big5').encode('utf8')
...
for i in userEachLineList:
    ...
    for k in userEachWordList:
        ...
        if len(rhymeList) > 0:
            ...
            try:
                ...
                print wIdRhymeBasedOnSql.decode('utf8').encode('big5')
    ...
    while len(userEachWordList) > 1:
        ...
        for l in userEachWordList:
            ...
            try:
                print existOrNotSql.decode('utf8').encode('big5')
                ...
                if examineResult is None:
                    ...
                    print wIdExamineSql.decode('utf8').encode('big5')
                    ...
                    # case 2: wId O, tags X
                        ...
                        print max_tIdSql.decode('utf8').encode('big5')
                    ...
                    print tagINSERTsql.decode('utf8').encode('big5')
                ...
                # if the tag was already in tag table
                    ...
                    if step == 1:
                        ...
                        print UPDATEsql.decode('utf8').encode('big5')
